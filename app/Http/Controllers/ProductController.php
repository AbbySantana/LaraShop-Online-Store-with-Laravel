...
class ProductController extends Controller
{
    ...
    public function insertar()
    {
        ...
        "image" => asset('img/game.png'), "price" => 270.00);
        ...
        ",
        "image" => asset('img/safe.png'), "price" =>104.80);
        ...
        "image" => asset('img/submarine.png'), "price" => 32.60);
        ...
        "image" => asset('img/game.png'), "price" =>40.00);
    }
    ...
    function show(int $id){
        ...
        $viewData["subtitle"] = "Listado de Productos";
        $viewData["product"] = ProductController::$products[$prodID];
